...
(function ($) {
  ...
  const __commonTable = $("#data-table, .data-table").DataTable({
  ...
  __commonTable.on('draw', function() {
    // call addDeleteEventListeners() for every 'Eliminar' button
  ...
  $( ".flatpickr_human_format" ).flatpickr({
    altInput: true,
    altFormat: "F j, Y",
    dateFormat: "Y-m-d"
  });
